...
// Lấy thông tin chuyến bay để sửa
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_flight'])) {
    ...
    // Chuyển hướng trở lại trang quản lý các chuyến bay sau khi cập nhật thành công
...
<body>
    <div class="container mt-5">
        ...
        <a href="manage_flights.php" class="btn btn-secondary mt-3">Quay lại</a>
    </div>
